...
export default (pane, cameraFolder) => {
    ...
    useLayoutEffect(() => {
        ...
        const cameraInput = cameraFolder.add(pane.addInput(cameraSettings, "camera", { options }));
        const splitInput = cameraFolder.add(pane.addInput(cameraSettings, "split"));
        return () => {
            cameraInput.dispose();
            splitInput.dispose();
        };
...
//# sourceMappingURL=useCameraPanel.js.map