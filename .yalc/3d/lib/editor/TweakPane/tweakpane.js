...
class ViewProps extends ValueMap {
    ...
    static create(opt_initialValue) {
        var _a, _b;
        const initialValue = opt_initialValue !== null && opt_initialValue !== void 0
            ? opt_initialValue
            : {};
        const coreObj = {
            disabled: (_a = initialValue.disabled) !== null && _a !== void 0
                ? _a
                : false,
            disposed: false,
            hidden: (_b = initialValue.hidden) !== null && _b !== void 0
                ? _b
                : false
        };
        const core = ValueMap.createCore(coreObj);
...
class Tab {
    ...
    add(item, opt_index) {
        const index = opt_index !== null && opt_index !== void 0
            ? opt_index
            : this.items_.length;
        this.items_.splice(index, 0, item);
...
class PointerHandler {
    ...
    onTouchEnd_(ev) {
        var _a;
        const touch = (_a = ev.targetTouches.item(0)) !== null && _a !== void 0
            ? _a
            : this.lastTouch_;
        const rect = this.elem_.getBoundingClientRect();
        handleUp();
...
function getSuitableDraggingScale(constraint, rawValue) {
    var _a;
    const sc = constraint && findConstraint(constraint, StepConstraint);
    const base = Math.abs((_a = sc === null || sc === void 0 ? void 0 : sc.step) !== null &&
        _a !== void 0
        ? _a
        : rawValue);
    ...
    controller: (args) => {
        ...
        if (c && findConstraint(c, ListConstraint)) {
            return new ListController(doc, {
                props: ValueMap.fromObject({
                    options: (_a = findListItems(c)) !== null && _a !== void 0
                        ? _a
                        : []
                }),
                value: value,
...
class Color {
    ...
    getComponents(opt_mode, type = "int") {
        return appendAlphaComponent(convertColor(removeAlphaComponent(this.comps_), { mode: this.mode, type: this.type }, {
            mode: opt_mode !== null && opt_mode !== void 0
                ? opt_mode
                : this.mode,
            type
        }), this.comps_[3]);
...
function shouldSupportAlpha$1(inputParams) {
    var _a;
    if ((inputParams === null || inputParams === void 0
        ? void 0
        : inputParams.alpha) ||
        ((_a =
...
const ObjectColorInputPlugin = {
    ...
    controller: (args) => {
        ...
        const expanded = "expanded" in args.params ? args.params.expanded : undefined;
        const picker = "picker" in args.params ? args.params.picker : undefined;
        const type = (_a = extractColorType(args.params)) !== null && _a !== void 0
            ? _a
            : "int";
        return new ColorController(args.document, {
            colorType: type,
...
const StringColorInputPlugin = {
    ...
    binding: {
        reader: (args) => {
            var _a;
            return createColorStringBindingReader((_a = extractColorType(args.params)) !== null && _a !== void 0
                ? _a
                : "int");
        },
        equals: Color.equals,
...
const NumberInputPlugin = {
    ...
    controller: (args) => {
        ...
        const formatter = (_b = "format" in args.params ? args.params.format : undefined) !==
            null && _b !== void 0
            ? _b
...
const BooleanMonitorPlugin = {
    ...
    controller: (args) => {
        ...
        return new MultiLogController(args.document, {
            formatter: BooleanFormatter,
            lineCount: (_a = args.params.lineCount) !== null && _a !== void 0
                ? _a
...
function createGraphMonitor(args) {
    ...
    return new GraphLogController(args.document, {
        ...
        lineCount: (_a = args.params.lineCount) !== null && _a !== void 0
            ...
            : Constants.monitor.defaultLineCount,
        props: ValueMap.fromObject({
            maxValue: (_b = "max" in args.params ? args.params.max : null) !== null &&
                _b !== void 0
                ? _b
                : 100,
            minValue: (_c = "min" in args.params ? args.params.min : null) !== null &&
                _c !== void 0
                ? _c
                : 0
        }),
...
function createTicker(document, interval) {
    return interval === 0
        ? new ManualTicker()
        : new IntervalTicker(document, interval !== null && interval !== void 0
            ? interval
...
function createMonitorBindingController(plugin, args) {
    ...
    const label = (_c = P.optional.string(args.params.label).value) !== null &&
        _c !== void 0
        ? _c
        : args.target.key;
...
class PluginPool {
    ...
    createInput(document, target, params) {
        ...
        const bc = this.pluginsMap_.inputs.reduce((result, plugin) => result !== null && result !== void 0
            ? result
    ...
    createMonitor(document, target, params) {
        const bc = this.pluginsMap_.monitors.reduce((result, plugin) => result !== null && result !== void 0
            ? result
    ...
    createBlade(document, params) {
        const bc = this.pluginsMap_.blades.reduce((result, plugin) => result !== null && result !== void 0
            ? result
    ...
    createBladeApi(bc) {
        ...
        const api = this.pluginsMap_.blades.reduce((result, plugin) => result !== null && result !== void 0
            ? result
            : plugin.api({
                controller: bc,
                pool: this
    ...
    controller(args) {
        ...
        const vc = new SliderTextController(args.document, {
            ...
            textProps: ValueMap.fromObject({
                ...
                formatter: (_b = args.params.format) !== null && _b !== void 0
                    ? _b
                    : numberToString
            }),
            value: createValue(v),
    ...
    return {
        ...
        controller(args) {
            ...
            const ic = new TextController(args.document, {
                ...
                props: ValueMap.fromObject({
                    formatter: (_a = args.params.format) !== null && _a !== void 0
                        ? _a
                        : (v) => String(v)
                }),
                value: createValue(args.params.value),
...
class Pane extends RootApi {
    constructor(opt_config) {
        ...
        const doc = (_a = config.document) !== null && _a !== void 0
            ? _a
            : getWindowDocument();
...
export { BladeApi, ButtonApi, FolderApi, InputBindingApi, ListApi, MonitorBindingApi, Pane, SeparatorApi, SliderApi, TabApi, TabPageApi, TextApi, TpChangeEvent, VERSION };
