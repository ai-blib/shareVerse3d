...
import selectionCandidates, { unselectableSet } from "../display/core/StaticObjectManager/raycast/selectionCandidates";
...
export const [setEditorDragEvent, getEditorDragEvent] = store(undefined);
createEffect(() => {
    const e = getEditorDragEvent();
    const pointRef = createRef({ x: 0, y: 0, z: 0 });
    const hitManagerRef = createRef();
...
//# sourceMappingURL=useEditorDragEvent.js.map