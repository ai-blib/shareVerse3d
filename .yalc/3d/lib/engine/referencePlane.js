...
const referencePlane = new Mesh(new PlaneGeometry(diameterScaled, diameterScaled, 4, 4), wireframeMaterial);
export default referencePlane;
createEffect(() => {
    if (!getReferencePlane() || getCameraRendered() !== mainCamera)
        return;
...
//# sourceMappingURL=referencePlane.js.map