...
import { FramebufferTexture, HalfFloatType, LinearFilter, NearestFilter, RGBAFormat, Vector2, WebGLRenderTarget } from "three";
import { positionChanged, quaternionChanged } from "../../../../../../display/utils/trackObject";
...
export class TemporalResolvePass extends Pass {
    ...
    checkCanUseSharedVelocityTexture() {
        const canUseSharedVelocityTexture = this._scene.userData.velocityTexture &&
            this.velocityPass.renderTarget.texture !==
                this._scene.userData.velocityTexture;
        if (canUseSharedVelocityTexture) {
            // let's use the shared one instead
            if (this.velocityPass.renderTarget.texture ===
        ...
        return (this.velocityPass.renderTarget.texture !==
            this.fullscreenMaterial.uniforms.velocityTexture.value);
    }
    checkNeedsResample() {
...
//# sourceMappingURL=TemporalResolvePass.js.map