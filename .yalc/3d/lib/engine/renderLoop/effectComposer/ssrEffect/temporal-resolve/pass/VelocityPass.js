...
import { Color, DataTexture, FloatType, HalfFloatType, Quaternion, RGBAFormat, Vector3, VideoTexture, WebGLRenderTarget } from "three";
...
export class VelocityPass extends Pass {
    ...
    setVelocityMaterialInScene() {
        ...
        for (const c of this.visibleMeshes) {
            ...
            if (c.userData.needsUpdatedReflections ||
...
//# sourceMappingURL=VelocityPass.js.map