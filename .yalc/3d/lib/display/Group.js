...
import { groupDefaults, groupSchema } from "../interface/IGroup";
...
export default class Group extends VisibleObjectManager {
    static componentName = "group";
    static defaults = groupDefaults;
    static schema = groupSchema;
    constructor() {
