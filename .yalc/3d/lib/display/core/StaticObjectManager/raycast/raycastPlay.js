...
import { clickSet, mouseDownSet, mouseUpSet, mouseOverSet, mouseOutSet, mouseMoveSet } from "./sets";
createEffect(() => {
    if (!getEditorPlay())
        return;
    ...
    const handle1 = pickable("down", mouseDownSet, (obj, e) => obj.onMouseDown?.(e));
...
//# sourceMappingURL=raycastPlay.js.map