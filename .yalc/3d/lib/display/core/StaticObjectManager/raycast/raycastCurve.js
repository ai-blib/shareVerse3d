...
import { getMultipleSelectionTargets, resetMultipleSelectionTargets } from "../../../../states/useMultipleSelectionTargets";
...
createEffect(() => {
    ...
    import("../../../Curve").then(({ default: Curve }) => {
        ...
        mouseEvents.on("click", (e) => {
            ...
            setTimeout(() => {
                if (handle0.done || getSelectionTarget() || selected)
                    return;
...
//# sourceMappingURL=raycastCurve.js.map