    ...
    constructor() {
        ...
        this.createEffect(() => {
            ...
            const handle = onBeforeRender(() => {
                ...
                const quat = centripetal ? applyCentripetalQuaternion(this) : undefined;
                ...
                if (this.lockTargetRotation === 'dynamic-lock') {
                    positionChanged(found.outerObject3d) && lockTargetRotation(found, true, quat);
                    return;
                }
                if (this.lockTargetRotation === 'dynamic-follow') {
                    positionChanged(found.outerObject3d) && followTargetRotation(found, true);
                    return;
                }
        ...
        }, [this.foundState.get, getSelectionTarget, getTransformControlsDragging, getEditorModeComputed]);
    }
