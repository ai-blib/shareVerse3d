                ...
                switch (extensionName) {
                    ...
                    default:
                        if (extensionsRequired.indexOf(extensionName) >= 0 &&
                            ...
                            console.warn('GLTFLoader: Unknown extension "' +
                                extensionName +
                                '".');
                        }
                }
    ...
    extendParams(materialParams, materialDef, parser) {
        ...
        if (metallicRoughness) {
            ...
            if (metallicRoughness.baseColorTexture !== undefined) {
                pending.push(parser.assignTexture(materialParams, "map", metallicRoughness.baseColorTexture, LinearEncoding));
            }
        }
...
class GLTFMaterialsSheenExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.sheenColorTexture !== undefined) {
            pending.push(parser.assignTexture(materialParams, "sheenColorMap", extension.sheenColorTexture, LinearEncoding));
        }
...
class GLTFMaterialsSpecularExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.specularColorTexture !== undefined) {
            pending.push(parser.assignTexture(materialParams, "specularColorMap", extension.specularColorTexture, LinearEncoding));
        }
        return Promise.all(pending);
    }
}
...
class GLTFTextureTransformExtension {
    ...
    extendTexture(texture, transform) {
        if (transform.texCoord !== undefined) {
            console.warn('GLTFLoader: Custom UV sets in "' +
                this.name +
...
class GLTFParser {
    ...
    loadBuffer(bufferIndex) {
        ...
        return new Promise(function (resolve, reject) {
            loader.load(LoaderUtils.resolveURL(bufferDef.uri, options.path), resolve, undefined, function () {
                reject(new Error('GLTFLoader: Failed to load buffer "' +
                    bufferDef.uri +
                    '".'));
            });
        });
    ...
    loadImageSource(sourceIndex, loader) {
        ...
        if (sourceDef.bufferView !== undefined) {
            ...
            throw new Error("GLTFLoader: Image " +
                sourceIndex +
    ...
    assignTexture(materialParams, mapName, mapDef, encoding) {
        ...
        return this.getDependency("texture", mapDef.index).then(function (texture) {
            ...
            if (mapDef.texCoord !== undefined &&
                ...
                console.warn("GLTFLoader: Custom UV set " +
                    mapDef.texCoord +
                    " for texture " +
                    mapName +
                    " not yet supported.");
    ...
    loadMaterial(materialIndex) {
        ...
        if (materialDef.emissiveTexture !== undefined &&
            materialType !== MeshBasicMaterial) {
            pending.push(parser.assignTexture(materialParams, "emissiveMap", materialDef.emissiveTexture, LinearEncoding));
        }
    ...
    loadNode(nodeIndex) {
        ...
        return (function () {
            ...
            parser
                ...
                return (ext.createNodeAttachment &&
