import { Clock, DoubleSide, InstancedMesh, Object3D, PlaneGeometry, ShaderMaterial, } from "three";
...
cube.depth = 1000;
cube.height = 10;
const sampler = new MeshSurfaceSampler(cube.nativeObject3d).build();
...
//# sourceMappingURL=testGrass.js.map